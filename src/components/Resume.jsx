...
const Resume = () => {
  ...
  const certifications = [
    ...
    '✓"МК Коллеж" Хиймэл оюун ухааны "Зуны сургалт-2" тэмцээнд амжилттай оролцож тэргүүн байр 2022 он',
    '✓"DXCUP Mongolia 2024" тэмцээнд сургуулиа төлөөлөн оролцож тэргүүн байр  2023 он',
    '✓NAPROCK(Procon) олон улсын программчлалын тэмцээний SPECIAL PRIZE шагнал авсан 2023 он',
    '✓"МК Коллеж" намрын спарткад-ын уртын харайлтын төрөлд 3-р байр  2024 он',
    '✓"МК Коллеж" гар бөмбөгийн аврага шалгаруулах тэмцээн тэргүүн байр 2024 он ',
    ...
    '✓"МК Коллеж" сагсан бөмбөгийн аврага шалгаруулах тэмцээн 3-р байр 2025 он'
  ];
